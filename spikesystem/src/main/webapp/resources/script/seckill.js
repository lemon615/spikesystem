...
var seckill = {
    ...
    URL: {
        now: function () {
            return "/spikesystem/seckill/time/now";
        },
        exposer: function (seckillId) {
            return "/spikesystem/seckill/" + seckillId + "/exposer";
        },
        execution: function (seckillId, md5) {
            return "/spikesystem/seckill/" + seckillId + "/" + md5 + "/execution";
        }
    },
    // 验证手机号码
            ...
            if (!seckill.validatePhone(userPhone)) {
                ...
                $("#killPhoneBtn").click(function () {
                    ...
                    if (seckill.validatePhone(inputPhone)) {
                        // 把电话写入cookie
                        $.cookie('userPhone', inputPhone, {expires: 7, path: '/spikesystem/seckill'});
                        // 验证通过 刷新页面
